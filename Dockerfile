...
RUN apt-get install -y curl php7.0 php7.0-curl php7.0-xdebug php7.0-mysql php7.0-xmlwriter php7.0-gd php7.0-apcu php7.0-apcu-bc php7.0-intl php7.0-bcmath php7.0-amqp
